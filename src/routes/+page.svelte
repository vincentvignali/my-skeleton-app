...
<div
	...
	<a
		...
		<div
			class="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 border-warning-500 border-dotted border-2 bg-warning-100 text-lg rounded-lg scale-75 outline-8 p-2">
			Nouveau
		</div>
